...
my_list = [num for num in range (1,6)]
 ...
 del top_song_list[0:3]
 print(top_song_list)

 top_song_list = ['Comfortably Numb', 'Time', 'Life On Your Own', 'Dream On', 'Nothing Else Matters', 'Neon Lights']
 top_song_list.clear()
 new_top_song_list =['Comfortably Numb-Pink Floyd','Time','Life On Your Own','Dram On','Nothing Else Matters','Neon Lights']
 print(new_top_song_list)
